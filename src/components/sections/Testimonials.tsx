    ...
    >
      <div className="container-content">
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-5 text-lg text-text-secondary">{intro}</p>
        </Reveal>
        ...
        {reviews.length > 0 && (
          ...
          >
            {reviews.map((r, i) => (
              <RevealItem
                key={i}
                className="flex flex-col gap-5 rounded-3xl border border-border-subtle bg-elevated/40 p-8 backdrop-blur-sm md:p-10"
              >
                {r.src ? (
                  <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-base">
                    <Image
                      src={r.src}
                ...
                <div className="mt-auto flex items-baseline justify-between gap-4 border-t border-border-subtle pt-5">
                  <div>
